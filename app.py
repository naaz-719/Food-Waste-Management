...
def show_dashboard():
    ...
    GROUP BY p.City;
    """, conn)
    st.subheader("1️. Providers & Receivers per City")
    ...
    LIMIT 1;
    """, conn)
    st.subheader("2️. Top Provider Type by Contribution")
    ...
    st.subheader(f"3️. Provider Contacts in {city_name.title()}")
    ...
    """, conn)
    st.subheader("4️. Receivers with Highest Number of Claims")
    ...
    st.subheader("5️. Total Food Available")
    ...
    LIMIT 1;
    """, conn)
    st.subheader("6️. City with Most Food Listings")
    ...
    ORDER BY Count DESC;
    """, conn)
    st.subheader("7️. Most Common Food Types")
    ...
    """, conn)
    st.subheader("8️. Claims Per Food Item")
    ...
    LIMIT 1;
    """, conn)
    st.subheader("9️. Top Provider by Successful Claims")
    ...
    GROUP BY Status;
    """, conn)
    st.subheader("10. Claims Percentage by Status")
    ...
    GROUP BY r.Name;
    """, conn)
    st.subheader("1️1. Average Quantity Claimed Per Receiver")
    ...
    """, conn)
    st.subheader("1️2. Most Claimed Meal Type")
    ...
    """, conn)
    st.subheader("14. Food Items Near Expiry (Next 3 Days)")
    ...
    LIMIT 10;
    """, conn)
    st.subheader("15. Top 10 Cities by Food Claims")
